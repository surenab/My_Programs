...
setenv vdkpool $2
setenv ver_tool "C"
echo "\033[1;29mRunning DRC with Calibre\033[0m"
...
printf "\ncell		$cellName		$cellName		$ver_tool">>$WorkPath/drc_lvs/cover_drc_$1.cnt
echo "\033[1;29mFinished make cover_drc.cnt file\033[0m"
#######################################################################################
######################RUN CNT FILE#####################################################
if (-d $WorkPath/drc_lvs/cells/calibre_drc_old) then
	echo "\033[1;29mRemoving calibre_drc_old directory\033[0m"
	rm -rf $WorkPath/drc_lvs/cells/calibre_drc_old 
endif
if (-d $WorkPath/drc_lvs/cells/calibre_drc) then
	echo "\033[1;29mCopy calibre_drc in calibre_drc_old directory\033[0m"
	mv -f $WorkPath/drc_lvs/cells/calibre_drc $WorkPath/drc_lvs/cells/calibre_drc_old
endif
...
echo "\033[1;29mVDK_POOL is $VDK_POOL\033[0m"
echo "\033[1;29mYou use CALIBRE\033[0m"
...
cd $WorkPath
echo "\033[1;29mStatus Information\033[0m"
tail $WorkPath/drc_lvs/cells/calibre_drc/$cellName/calibre_drc.log -n 3
