...
set char_edge_lib 	"hd1p_db"
set char_edge_left_y  	"16FF_d0907_v0d2_row_edge_sep_Vss_x2_l"
set char_edge_right_y 	"16FF_d0907_v0d2_row_edge_sep_Vss_x2_r"
set char_edge_00	"16FF_d0907_v0d2_corner_dummy_sep_wells_x1_l"
set char_edge_01	"16FF_d0907_v0d2_corner_dummy_sep_wells_x1_l"
set char_edge_10	"16FF_d0907_v0d2_corner_dummy_sep_wells_x1_r"
set char_edge_11	"16FF_d0907_v0d2_corner_dummy_sep_wells_x1_r"
set char_edge_top   	"16FF_d0907_v0d2_sep_wells_strap_edge_x2"
set char_edge_bot   	"16FF_d0907_v0d2_sep_wells_strap_edge_x2"
...
proc exp_level0 {design lname cname rx cx } {
	...
	set ii [expr 2*$rx]
	while {$ii} {
		le::createInst -design $design -origin [list 0 [expr ($ii-1)*[expr $dy/2]]] -libName $char_edge_lib -cellName $char_edge_left_y 	-viewName layout -orient "R0" -rows 1 -dy [expr $dy/2]
		set ii [expr $ii -1]
	}
	
	set ii [expr 2*$rx]
	while {$ii} {
		le::createInst -design $design -origin [list [expr $const_countc*$dx] [expr ($ii-1)*[expr $dy/2]]] -libName $char_edge_lib -cellName $char_edge_right_y  	-viewName layout -orient "MY" -rows 1 -dy [expr $dy/2]
		set ii [expr $ii -1]
	}
...
proc port_ip_char16 {netlist edd lname cname  chcell_cellname rx cx} {
	...
	set ports_opv [lindex $all_ports 5]
	set ports_oph [lindex $all_ports 6]
