source /slowfs/am04dwt2p013/projects/layout/ts16/hd1p_hd6t/users/suren/scripts/chcell_maker/get_ip_op_pin.tcl
source /slowfs/am04dwt2p013/projects/layout/ts16/hd1p_hd6t/users/suren/scripts/chcell_maker/chcell_dialog.tcl
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#////////////////////////VIA sizes
...
proc get_flatten_shapes {cname lname} {
	...
	db::destroy [dm::getCells for_chcell -libName $lname]
	set metalx ""
		...
		if {$orient == "v"} {
			...
			le::createLabel $pin_name_oph -parent $edd -lpp [list $xlvs_layer "drawing"] -origin $op_cood -height 0.02
				...
				#////////////////////////////////////count=2///////////////////////////////////////////////////////////////////////////////
					...
					set pin_name_oph [plus_fin_char $pin_name_oph $all_ports $count]
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
source /slowfs/am04dwt2p013/projects/layout/ts16/hd1p_hd6t/users/suren/scripts/chcell_maker/exceptions.tcl	
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
proc main {netlist chcell_cellname chcell_libname or} {
	...
	if {($res_char == 0) && ($res_red == 0)} {
		...
		if {$err1!=-1} {
			...
			puts "\n//////////////////////////////Stsrting level 0//////////////////////////////////////////////////////////"
			level0 $desoa $lib_name $cell_name $count $orient
